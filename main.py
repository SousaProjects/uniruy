...
def atualizar_main():
    try:
        ...
        button_confirmar = Button(frame_baixo, text='Confirmar',font=("Arial 10 bold"), width=12, bg="yellow", fg=co0,command=atualizar)
...
button_pesquisa = Button(frame_direita_cima, width=15, text="Pesquisar", command=mostrar_pesquisa)
